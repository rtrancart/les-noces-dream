...
/* Les FAQ de catégorie proviennent désormais du champ `faq` de la table
 * `public.categories` (éditable en admin) et sont construites via
 * buildFaqPageJsonLd(). L'ancienne table codée en dur a été supprimée. */
