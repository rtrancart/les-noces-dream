...
export default function ClientFavoris() {
  ...
  const fetchFavoris = async () => {
    ...
    const { data } = await supabase
      .from("favoris")
      .select("id, prestataire:prestataires_public!favoris_prestataire_id_fkey(id, nom_commercial, slug, ville, region, photo_principale_url, note_moyenne, nombre_avis, categorie_mere:categories!prestataires_categorie_mere_id_fkey(nom))")
      .eq("user_id", user.id)
