...
const FROM_DOMAIN = "notify.lesnoces.net" // Verified/delegated sender subdomain — must match SENDER_DOMAIN unless display_from_root is enabled
...
const SAMPLE_PROJECT_URL = "https://les-noces.lovable.app"
